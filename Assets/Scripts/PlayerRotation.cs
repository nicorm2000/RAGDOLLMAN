...
public class PlayerRotation : MonoBehaviour
{
    ...
    public void PlayerRotationCalculation(Camera cam, GameObject playerParts, float turnSpeed)
    {
        ...
        playerParts.GetComponent<ConfigurableJoint>().targetRotation = Quaternion.Slerp(playerParts.GetComponent<ConfigurableJoint>().targetRotation, Quaternion.Inverse(rotation), Time.deltaTime * turnSpeed);
    }
}

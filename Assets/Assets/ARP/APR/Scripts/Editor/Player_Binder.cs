...
public class Player_Binder : EditorWindow
{
    //Editor window
    public Texture tex;
    private static Player_Binder _instance;
    ...
    static void APRPlayerBinderWindow()
    {
        if (_instance == null)
        {
            Player_Binder window = ScriptableObject.CreateInstance(typeof(Player_Binder)) as Player_Binder;

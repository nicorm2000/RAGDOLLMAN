...
public class Player_Settings_Injector : EditorWindow
{
    //Editor window
    public Texture tex;
    private static Player_Settings_Injector _instance;
    ...
    static void APRPlayerSettingsInjectorWindow()
    {
        if (_instance == null)
        {
            Player_Settings_Injector window = ScriptableObject.CreateInstance(typeof(Player_Settings_Injector)) as Player_Settings_Injector;
